...
public class MenuFacadeREST extends AbstractFacade<Menu> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Menu entity) {
        super.edit(entity);
    }
    ...
    public Menu find(@PathParam("id") int id) {
    ...
    public List<Menu> findAll() {
        StoredProcedureQuery spq = em.createNamedStoredProcedureQuery("seleccionarMenu");
        StoredProcedureQuery storedProcedure = spq.setParameter("p_ID_MENU", 0);
