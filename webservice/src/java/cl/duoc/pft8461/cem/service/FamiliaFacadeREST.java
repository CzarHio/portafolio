 ...
 */
@Stateless
@Path("entidades.familia")
public class FamiliaFacadeREST extends AbstractFacade<Familia> {

    @PersistenceContext(unitName = "webservicePU")
    private EntityManager em;

    public FamiliaFacadeREST() {
        super(Familia.class);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Familia entity) {
        super.edit(entity);
    }
    ...
    public Familia find(@PathParam("id") int id) {
    ...
    public List<Familia> findAll() {
        StoredProcedureQuery spq = em.createNamedStoredProcedureQuery("seleccionarFamilia");
        StoredProcedureQuery storedProcedure = spq.setParameter("p_ID_FAMILIA", 0);
